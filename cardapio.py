...
def main(page:ft.Page):
    ...
    dados_lanche = [{'id': 1, 'nome': 'farol', 'preco': '25,00', 'descricao': 'pão da casa, carne 100g, queijo, presunto, bacon triturado, tomate, alface, molho.', 'classe': 'lanche_artesanal'},
                        {'id': 2, 'nome': 'cruzeirinho', 'preco': '25,00', 'descricao': 'pão da casa, carne 100g, frango, queijo, catupiry, tomate, alface, molho.', 'classe': 'lanche_artesanal'},
                        {'id': 3, 'nome': 'nativo', 'preco': '28,00', 'descricao': 'pão da casa, carne 100g, calabresa, queijo, ovo, cebola caramelizada, tomate, alface, molho.', 'classe': 'lanche_artesanal'},
                        {'id': 4, 'nome': 'atanagildo', 'preco': '30,00', 'descricao': 'pão da casa, carne 100g, farofa de calabresa e bacon, queijo, presunto, ovo, tomate, alface, molho.', 'classe': 'lanche_artesanal'},
                        {'id': 5, 'nome': 'crumaí', 'preco': '40,00', 'descricao': 'pão da casa, 2 carnes de 100g, calabresa, bacon, frango, cheddar, queijo, cebola caramelizada, tomate, alface, molho.', 'classe': 'lanche_artesanal'},
                        {'id': 6, 'nome': 'mistão', 'preco': '10,00', 'descricao': 'pão da casa, queijo e presunto.', 'classe': 'lanche_tradicional'},
                        {'id': 7, 'nome': 'hamburguinho', 'preco': '10,00', 'descricao': 'pão da casa, c/hambúrguer, tomate, alface, molho.', 'classe': 'lanche_tradicional'},
                        {'id': 8, 'nome': 'x-salada', 'preco': '15,00', 'descricao': 'pão da casa, c/hambúrguer, queijo, milho verde, tomate, alface, molho.', 'classe': 'lanche_tradicional'},
                        {'id': 9, 'nome': 'x-calabresa', 'preco': '20,00', 'descricao': 'pão da casa, c/hambúrguer, calabresa, quejo, presunto, tomate, alface, molho.', 'classe': 'lanche_tradicional'},
                        ...
                        {"id": 12, "nome": "x-mamãe", "preco": "30,00", "descricao": "pão da casa, hambúrguer, calabresa, ovo, bacon, frango,  queijo, presunto, tomate, alface, molho.", "classe": "lanche_tradicional"}
                ...
                def enviar_dados(e):
                    ...
                    try:
                        ...
                        conn = psycopg2.connect(
                            host="dpg-d62euiggjchc73abrg8g-a.oregon-postgres.render.com",
                            port="5432",
                            database="bd_sherlon_yfy9",
                            user="bd_sherlon_yfy9_user",
                            password="QrbygUildj4EcVaRAzYS1g6HTUSjd9iK"
                        )
                        cursor = conn.cursor()
                        # Comando SQL
                        sql = """
